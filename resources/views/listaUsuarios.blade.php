...
<body class="bg-cover pt-0 pb-0 bg-center bg-repeat font-comic-sans font-bold fondo-opaco-amarillo">
    ...
    <div class="bg-yellow-100 p-6 rounded-lg mx-auto max-w-5xl">
        <h2 class="text-xl font-bold mb-4 text-center">Usuarios registrados</h2>
        <div class="flex mb-4">
        ...
        <div class="bg-white shadow-md rounded-lg p-4">
            <table id="usuarios" class="display nowrap">
                <thead>
                    <tr>
                        <th class="font-bold">Nombre de usuario</th>
                        <th class="font-bold">Correo</th>
                        <th class="font-bold">Tipo Usuario</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="flex justify-around">
                            <a title="Editar datos" href="{{ route('usuario.mostrarPorId', ['token' => $dato->token]) }}" class="bg-green-500 hover:bg-green-700 text-white font-bold py-1 px-2 rounded focus:outline-none focus:shadow-outline">
                                <i class="bi bi-pencil-square"></i>
                            </a>
                            <a href="{{ route('usuario.baja', ['token' => $dato->token]) }}" onclick="confirmarBaja(event)" title="Dar de baja" type="submit" class="bg-yellow-500 hover:bg-yellow-700 text-white font-bold py-1 px-2 rounded focus:outline-none focus:shadow-outline">
