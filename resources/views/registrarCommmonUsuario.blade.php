...
<body oncopy="return false" onpaste="return false" class="bg-cover pt-0 pb-0 bg-center bg-no-repeat font-comic-sans font-bold fondo-opaco-amarillo">
    ...
    <div class="register-container bg-yellow-100 p-8 rounded-lg mx-auto max-w-lg">
        ...
        <form id="formulario" action="{{ route('usuarioCommon.insertar') }}" enctype="multipart/form-data" method="post">
            @csrf
            <div class="mb-4">
            ...
            <div class="mb-4">
                ...
                <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="confirmar_correo" name="confirmar_correo" type="email" placeholder="Confirma tu correo electrónico" autocomplete="off" required>
            </div>
            <div class="mb-4">
